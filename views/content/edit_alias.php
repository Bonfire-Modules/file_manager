				...
				<div class='controls'>
					...
					<span class="help-inline"><?php echo form_error('alias_target_model'); ?></span>
                        ...
                        <div class="control-group <?php echo form_error('alias_target_model_row_id') ? 'error' : ''; ?>">
                                ...
                                <div class='controls'>
                                       <input id="alias_target_model_row_id" type="text" name="alias_target_model_row_id" maxlength="255" value="<?php echo set_value('target_model_row_id', isset($alias_record['target_model_row_id']) ? $alias_record['target_model_row_id'] : ''); ?>"  />
