				...
				<fieldset>
					...
					<?php if(in_array($file_record['extension'], array("png", "jpg", "bmp", "gif"))) : ?>
						<div class="control-group">
							<?php echo form_label(lang('file_manager_table_field_thumbnail'), '', array('class' => "control-label") ); ?>
							<div class='controls'>
					...
					<div class="control-group <?php echo form_error('file_name') ? 'error' : ''; ?>">
						<?php echo form_label(lang('file_manager_table_field_file_name'), 'file_name', array('class' => "control-label") ); ?>
						<div class='controls'>
					...
					<div class="control-group <?php echo form_error('description') ? 'error' : ''; ?>">
						<?php echo form_label(lang('file_manager_table_field_description'), 'description', array('class' => "control-label") ); ?>
						<div class='controls'>
					...
					<div class="control-group <?php echo form_error('tags') ? 'error' : ''; ?>">
						<?php echo form_label(lang('file_manager_table_field_tags'), 'tags', array('class' => "control-label") ); ?>
						<div class='controls'>
